#############################################################################
# Makefile for building: Tornado.app/Contents/MacOS/Tornado
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  Tornado.pro
# Template: app
# Command: /Users/carolagille/Qt/5.5/clang_64/bin/qmake -spec macx-clang CONFIG+=x86_64 CONFIG+=qml_debug CONFIG+=force_debug_info CONFIG+=separate_debug_info -o Makefile Tornado.pro
#############################################################################
...
TARGET        = Tornado.app/Contents/MacOS/Tornado
...
$(TARGET):  $(OBJECTS)  
	@test -d Tornado.app/Contents/MacOS/ || mkdir -p Tornado.app/Contents/MacOS/
...
Makefile: Tornado.pro .qmake.cache /Users/carolagille/Qt/5.5/clang_64/mkspecs/macx-clang/qmake.conf /Users/carolagille/Qt/5.5/clang_64/mkspecs/features/spec_pre.prf \
		...
		/Users/carolagille/Qt/5.5/clang_64/mkspecs/features/unix/separate_debug_info.prf \
	...
	$(QMAKE) -spec macx-clang CONFIG+=x86_64 CONFIG+=qml_debug CONFIG+=force_debug_info CONFIG+=separate_debug_info -o Makefile Tornado.pro
...
Tornado.app/Contents/PkgInfo: 
	@test -d Tornado.app/Contents || mkdir -p Tornado.app/Contents
	@$(DEL_FILE) Tornado.app/Contents/PkgInfo
	@echo "APPL????" > Tornado.app/Contents/PkgInfo
Tornado.app/Contents/Resources/empty.lproj: 
	@test -d Tornado.app/Contents/Resources || mkdir -p Tornado.app/Contents/Resources
	@touch Tornado.app/Contents/Resources/empty.lproj
	
Tornado.app/Contents/Info.plist: 
	@test -d Tornado.app/Contents || mkdir -p Tornado.app/Contents
	@$(DEL_FILE) Tornado.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.Tornado,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,Tornado,g" -e "s,@TYPEINFO@,????,g" /Users/carolagille/Qt/5.5/clang_64/mkspecs/macx-clang/Info.plist.app >Tornado.app/Contents/Info.plist

all: Makefile \
		Tornado.app/Contents/PkgInfo \
		Tornado.app/Contents/Resources/empty.lproj \
		Tornado.app/Contents/Info.plist $(TARGET)
