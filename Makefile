...
# Project:  Tornado.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang -o Makefile Tornado.pro
#############################################################################
...
CXXFLAGS      = -pipe -fopenmp -I/usr/include/ImageMagick -msse -msse2 -msse3 -march=native -O2 -std=c++11 -Wall -W -Wno-unused-parameter -D_REENTRANT -fPIC $(DEFINES)
...
Makefile: Tornado.pro .qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-clang -o Makefile Tornado.pro
