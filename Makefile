...
Makefile: Tornado.pro ../../../../Qt/5.5/clang_64/mkspecs/macx-clang/qmake.conf ../../../../Qt/5.5/clang_64/mkspecs/features/spec_pre.prf \
		../../../../Qt/5.5/clang_64/mkspecs/qdevice.pri \
		../../../../Qt/5.5/clang_64/mkspecs/features/device_config.prf \
		../../../../Qt/5.5/clang_64/mkspecs/common/unix.conf \
		../../../../Qt/5.5/clang_64/mkspecs/common/mac.conf \
...
Tornado.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.Tornado,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,Tornado,g" -e "s,@TYPEINFO@,????,g" ../../../../Qt/5.5/clang_64/mkspecs/macx-clang/Info.plist.app >Tornado.app/Contents/Info.plist
